...
## Q.30: What is @ConfigurationProperties?
Binds external configuration to a Java object, providing type-safe configuration with validation support.
...
## Q.31: What is @RestController?
A convenience annotation that combines `@Controller` and `@ResponseBody`. It's used for REST APIs where methods return data that should be written directly to the HTTP response body.


## Q.32: What is @RequestMapping?
...
## Q.40: What is lazy loading vs eager loading?
...
## Q.41: What is N+1 query problem?
...
## Q.45: What is @ConditionalOnProperty?
...
## Q.46: What is @ConditionalOnClass?
...
## Q.47: What is @EnableConfigurationProperties?
